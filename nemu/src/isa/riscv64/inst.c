...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, {printf("hh\n");assert(0);R(dest) = (word_t)(((__int128_t)((__uint128_t)(((int64_t)src1 >= 0) ? src1 : -src1) * (__uint128_t)src2) * (((int64_t)src1 >= 0) ? 1 : -1) ) >> 64);});
