...
VL_INLINE_OPT QData Vtop___024root___change_request_1(Vtop___024root* vlSelf) {
    ...
    __req |= ((vlSelf->top__DOT__my_ifu__DOT__rdata ^ vlSelf->__Vchglast__TOP__top__DOT__my_ifu__DOT__rdata));
    VL_DEBUG_IF( if(__req && ((vlSelf->top__DOT__my_ifu__DOT__rdata ^ vlSelf->__Vchglast__TOP__top__DOT__my_ifu__DOT__rdata))) VL_DBG_MSGF("        CHANGE: vsrc/IFU.v:12: top.my_ifu.rdata\n"); );
    // Final
    vlSelf->__Vchglast__TOP__top__DOT__my_ifu__DOT__rdata 
