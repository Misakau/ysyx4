...
VL_INLINE_OPT QData Vtop___024root___change_request_1(Vtop___024root* vlSelf) {
    ...
    VL_DEBUG_IF( if(__req && ((vlSymsp->TOP__top__DOT__my_exu__DOT__adder__DOT__adder_low.__Vcellout__gen__c ^ vlSelf->__Vchglast__TOP__top__DOT__my_exu__DOT__adder__DOT__adder_low____Vcellout__gen__c))) VL_DBG_MSGF("        CHANGE: vsrc/CLU4.v:4: __Vcellout__gen__c\n"); );
    ...
    VL_DEBUG_IF( if(__req && ((vlSymsp->TOP__top__DOT__my_exu__DOT__adder__DOT__adder_high.__Vcellout__gen__c ^ vlSelf->__Vchglast__TOP__top__DOT__my_exu__DOT__adder__DOT__adder_high____Vcellout__gen__c))) VL_DBG_MSGF("        CHANGE: vsrc/CLU4.v:4: __Vcellout__gen__c\n"); );
