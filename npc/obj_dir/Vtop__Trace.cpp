...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgIData(oldp+70,(vlSelf->instr_i),32);
        tracep->chgQData(oldp+71,(vlSelf->pc),64);
        tracep->chgCData(oldp+73,((0x7fU & vlSelf->instr_i)),7);
        tracep->chgCData(oldp+74,((vlSelf->instr_i 
                                   >> 0x19U)),7);
        tracep->chgCData(oldp+75,((0x1fU & (vlSelf->instr_i 
                                            >> 7U))),5);
