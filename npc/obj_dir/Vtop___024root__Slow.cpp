...
void Vtop___024root___initial__TOP__1(Vtop___024root* vlSelf) {
    ...
    __Vtemp1[3U] = 0x555f5f2fU;
    __Vtemp1[4U] = 0x616e672fU;
    __Vtemp1[5U] = 0x69612f77U;
    __Vtemp1[6U] = 0x2f6d6564U;
    vlSymsp->_vm_contextp__->dumpfile(VL_CVT_PACK_STR_NW(7, __Vtemp1));
