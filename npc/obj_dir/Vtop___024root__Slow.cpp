...
void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->d_rw_addr_o = VL_RAND_RESET_Q(64);
    vlSelf->d_rw_req_o = VL_RAND_RESET_I(1);
    vlSelf->d_rw_valid_o = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(128, vlSelf->d_rw_w_data_o);
    VL_RAND_RESET_W(128, vlSelf->d_data_read_i);
    vlSelf->d_rw_ready_i = VL_RAND_RESET_I(1);
