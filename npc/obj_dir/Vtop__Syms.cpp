...
Vtop__Syms::Vtop__Syms(VerilatedContext* contextp, const char* namep,Vtop* modelp)
    ...
    , TOP__top__DOT__my_exu__DOT__alu64__DOT__adder1__DOT__adder_high(Verilated::catName(namep, "top.my_exu.alu64.adder1.adder_high"))
    , TOP__top__DOT__my_exu__DOT__alu64__DOT__adder1__DOT__adder_low(Verilated::catName(namep, "top.my_exu.alu64.adder1.adder_low"))
    ...
    , TOP__top__DOT__my_exu__DOT__nextaddr__DOT__pcadder__DOT__adder_low(Verilated::catName(namep, "top.my_exu.nextaddr.pcadder.adder_low"))
{
    ...
    TOP.__PVT__top__DOT__my_exu__DOT__alu64__DOT__adder1__DOT__adder_high = &TOP__top__DOT__my_exu__DOT__alu64__DOT__adder1__DOT__adder_high;
    TOP.__PVT__top__DOT__my_exu__DOT__alu64__DOT__adder1__DOT__adder_low = &TOP__top__DOT__my_exu__DOT__alu64__DOT__adder1__DOT__adder_low;
    ...
    TOP__top__DOT__my_exu__DOT__alu64__DOT__adder1__DOT__adder_high.__Vconfigure(this, true);
    TOP__top__DOT__my_exu__DOT__alu64__DOT__adder1__DOT__adder_low.__Vconfigure(this, false);
