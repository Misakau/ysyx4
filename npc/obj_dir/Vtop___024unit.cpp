...
VL_INLINE_OPT void Vtop___024unit____Vdpiimwrap_get_instr_TOP____024unit(QData/*63:0*/ instr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop___024unit____Vdpiimwrap_get_instr_TOP____024unit\n"); );
    // Body
    svLogicVecVal instr__Vcvt[2];
    for (size_t instr__Vidx = 0; instr__Vidx < 1; ++instr__Vidx) VL_SET_SVLV_Q(64, instr__Vcvt + 2 * instr__Vidx, instr);
